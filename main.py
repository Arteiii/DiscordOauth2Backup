...
def run_development():
    ...
    # 'discordoauth2backup.app:app': The import string representing the location of the FastAPI instance
    #                Replace 'discordoauth2backup' with the actual name of your package, and 'app' with the FastAPI instance
...
def run_custom(**kwargs):
    ...
    uvicorn.run("discordoauth2backup.app:app", **kwargs)
